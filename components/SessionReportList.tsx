    ...
    <div className="space-y-4">
      {reports.map((report) => (
        ...
        >
          ...
          <div className={`w-3 ${report.is_new ? 'bg-indigo-500' : 'bg-slate-100'} transition-colors`}></div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">{report.created_at}</span>
                  {report.is_new && (
